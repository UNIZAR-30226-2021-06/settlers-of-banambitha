...
export class WsService implements OnDestroy{
  ...
  public static readonly partidaJugada:        String = WsService.appPrefix + "/partida/jugada"
  public static readonly partidaRecargar:      String = WsService.appPrefix + "/partida/recargar"
  public static readonly proponerComercio:     String = WsService.appPrefix + "/partida/comercio/proponer"
  public static readonly aceptarComercio:      String = WsService.appPrefix + "/partida/comercio/aceptar"
  public static readonly rechazarComercio:     String = WsService.appPrefix + "/partida/comercio/rechazar"
  public static readonly enviarMensajePrivado: String = WsService.appPrefix + "/enviar/privado"
  ...
  public static readonly usuario_act:          string = "/usuario-act/"
