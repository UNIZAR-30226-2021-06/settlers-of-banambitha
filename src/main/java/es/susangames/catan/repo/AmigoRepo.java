...
public interface AmigoRepo extends JpaRepository<Amigo, AmigoPK> {
	...
	@Modifying
	@Transactional
	@Query(value = "DELETE FROM amigo WHERE usuario1_id = :usuarioId OR usuario2_id = :usuarioId", nativeQuery = true)
	public void eliminarAmigos(@Param("usuarioId") String usuarioId);
}
